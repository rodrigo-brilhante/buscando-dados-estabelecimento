...
class ReclameAqui():
    ...
    def getReviewsJson(self, id, qtdReview):
        dataJson = []
        contador=0
        while contador <= int(qtdReview):
            url = "https://iosearch.reclameaqui.com.br/raichu-io-site-search-v1/query/companyComplains/10/"+str(contador)+"?company="+id
            ...
            for i in aux['complainResult']['complains']['data']:
                dataJson.append(i)
            contador+=10
            time.sleep(1)
    ...
    def getReviews(self, id, nomeLocal, qtdReview):
        reviwesJson = self.getReviewsJson(id, qtdReview)
        ...
        for review in reviwesJson:
            ...
            contador+=1
            # print("bucando review geral reclame aqui: ",contador)
        return dadosReviews
