	...
	def get(self, url):
		with requests.Session() as session:
			try:
				...
				breakdownNotas = {
					'nota_5':pontuacaoDosViajantes[0].getText(),
					'nota_4':pontuacaoDosViajantes[1].getText(),
					'nota_3':pontuacaoDosViajantes[2].getText(),
					'nota_2':pontuacaoDosViajantes[3].getText(),
					'nota_1':pontuacaoDosViajantes[4].getText(),
				}
