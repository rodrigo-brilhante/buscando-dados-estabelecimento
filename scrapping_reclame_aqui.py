...
def getReclamacoesNaoRespondidas(id):
...
def getReclamacoesRespondidas(id):
...
def getReclamacoesAvaliadas(id):
...
def getReviews(id, nomeLocal):
    reclamacoesNaoRespondidas = getReclamacoesNaoRespondidas(id)
    reclamacoesRespondidas = getReclamacoesRespondidas(id)
    reclamacoesAvaliadas = getReclamacoesAvaliadas(id)
...
with requests.Session() as session:
    try:
        ...
        for avaliacao in dadosAvaliacoes:
            avaliacaoes.append(getAvaliacao(avaliacao['index']))
        ...
        problemas = getProblemas(dados['complainResult']['complains'])
     
        reviews = getReviews(id, nomeDoLocal)
